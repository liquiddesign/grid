 ...
 * @method \Nette\Forms\Controls\TextInput addFilterDate(callable $filterExpression, string $name, ?string $label = null, ?array $configuration = [])
 * @method \Nette\Forms\Controls\TextInput addFilterDatetime(callable $filterExpression, string $name, ?string $label = null, ?array $configuration = [])
 */
